...
In this application you can login with an existing user.

You have three link in the nav, they are:
* Home
* New question
* Leader board
...
There are two tabs "Unansweres questions" and "Answered questions"

### New question

There is a form to insert new question with two option

### Leader bord

It summarise the votes, question creted and score of the users.
